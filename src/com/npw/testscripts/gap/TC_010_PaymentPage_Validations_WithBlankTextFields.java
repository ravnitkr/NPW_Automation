...
public class TC_010_PaymentPage_Validations_WithBlankTextFields extends BaseTest {
	...
	private static String TestCaseName = "TC_010_PaymentPage_Validations_WithBlankTextFields";
	...
	public static void GetAllDetailsFromResidentialPage()
		...
		Reporting.Testcasename = "Get all validations from the Payment detail page when textfields are kept blank";
		...
		try {
			...
			// Get all validations
			bStatus = GapPageObject.getAllValidationMessages("PaymentDetailsBLANKPage");
			if (!bStatus) {
