...
public class TC_003_GreatDecisionPage_Validations_INvalidValuesEntered extends BaseTest {

	private static boolean bStatus;
	private static String TestData_path_GAP = "TestData/TestData.xls";
	private static String sheetName = "GAP";
	private static String TestCaseName = "TC_003_GreatDecisionPage_Validations_INvalidValuesEntered";
	...
	public static void getAllValidationsFromGreatDecisionPage()
		...
		Reporting.Testcasename = "Get validations from the GREAT DECISION page when invalid values are entered";
